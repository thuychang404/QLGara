...
public class Validation {
    ...
    public static boolean isCustomerValid(Customer cus) {
        if (isNameValid(cus.getName()) && isDateValid(cus.getDOB()) && isAddressValid(cus.getAddress()) && isPhoneValid(cus.getTel()) && isNoteValid(cus.getNote())) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isCarValid(Car c) {
        if (isLicenseValid(c.getLicensePlate()) && isModelValid(c.getType()) && isMakerValid(c.getAutomaker()) && isNoteValid(c.getDes())) {
            return true;
        }
        return false;
    }
